...
(() => {
  ...
  const TR = {
    ...
    shopSoonTitle: 'Çok yakında.',
    shopSoonLead: 'Online mağazamız hazırlanıyor. O zamana kadar tüm çeşitlerimizi F1 8’deki mağazamızda, kişisel danışmanlıkla bulabilirsiniz.',
    shopSoonGallery: 'Galerideki kombinlere bakın',
    navGallery: 'Galeri',
    galleryTitle: 'Mağazamızdan kombinler.',
    galleryLead: 'Müşterilerimiz ve modellerimiz PARLA takımlarıyla. Beğendiğiniz bir kombin varsa uğrayın, birlikte bedeninize göre bulalım.',
    galleryCtaTitle: 'Beğendiğiniz bir kombin mi var?',
    galleryCtaLead: 'Fotoğrafı gösterin, gerisini biz halledelim. F1 8, Mannheim.',
    galleryOpen: 'Büyüt',
    galleryAlt: 'PARLA Herrenmode’dan kombin',
